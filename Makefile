...
EBPF_CFLAGS = -target bpf -D__BPF_TRACING__ -I/usr/include/$(shell uname -m)-linux-gnu
...
.PHONY: all install test verify clean reinstall info secure install-secure test-secure
